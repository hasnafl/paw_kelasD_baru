              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu" >
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="poli_kb.php">Poli KB</a></li>    
                          <li><a class="" href="poli_kia.php">Poli KIA</a></li>                              
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
            ...
            <div id="page-inner">
                ...
                <!-- Advanced Tables -->
                    <div class="panel panel-default">
                                    <?php
                                        $i = 0;
                                        $sql	= 'select * from pendaftaran1 where poli = "kb" and tgl_masuk = "'.date("Y-m-d").'" order by tgl_masuk asc';
                        ...
                        <div class="panel-body">
                                  ...
                                  <thead>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="editpolikb.php?ni=<?php echo $data['id_pasien'];?>" class="btn btn-primary btn-sm" ><i class="fa fa-edit">  DETAIL</i></a>
                            ...
                            <a class="btn btn-primary" href="kb.php"><i class="fa fa-success"></i>  Tampilkan semua</a>
                            <!--akhir modal--!>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
