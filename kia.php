            ...
            <div id="page-inner">
                ...
                <!-- Advanced Tables -->
                    <div class="panel panel-default">
                                    <?php
                                        $i = 0;
                                        $sql	= 'select * from pendaftaran1 where poli = "kia" order by tgl_masuk asc';
                        ...
                        <div class="panel-body">
                            ...
                            <a class="btn btn-primary" href="poli_kia.php"><i class="fa fa-success"></i>  Tampilkan hari ini</a>
                            <!--akhir modal--!>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
