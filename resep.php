            ...
            <div id="page-inner">
                ...
                <!-- Advanced Tables -->
                    <div class="panel panel-default">
                                    <?php
                                        $i = 0;
                                        $sql	= 'select * from pendaftaran1 where tgl_masuk = "'.date("Y-m-d").'" order by tgl_masuk asc';
                        ...
                        <div class="panel-body">
                                  ...
                                  <thead>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="resep1.php?ni=<?php echo $data['id_pasien'];?>" class="btn btn-primary btn-sm" ><i class="fa fa-edit">  DETAIL</i></a>
                                        </tr> 
                                      <?php
                                      }
                                      ?>
                            ...
                            <a class="btn btn-primary" href="dataresep.php"><i class="fa fa-success"></i>  Tampilkan Semua data</a>
                            <!--modal--!>
