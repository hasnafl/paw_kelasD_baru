              ...
              <ul class="sidebar-menu">                
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="hak_akses.php">Hak Akses</a></li>
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                  ...
                  <li class="sub-menu" >
                      ...
                      <ul class="sub">
                          ...
                          <li ><a class="" href="poli_kb.php">Poli KB</a></li>    
                          <li class="active"><a class="" href="poli_kia.php">Poli KIA</a></li>                              
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="basic_table.html">Laporan Pengeluaran Obat</a></li>
                          <li><a class="" href="basic_table.html">Diagnosa</a></li>
                      </ul>
                  </li>
              </ul>
              <!-- sidebar menu end-->
            ...
            <div id="page-inner">
                ...
                <!-- Advanced Tables -->
                    <div class="panel panel-default">
                                    <?php
                                        $i = 0;
                                        $sql	= 'select * from pendaftaran1 where poli = "kia" and tgl_masuk = "'.date("Y-m-d").'" order by tgl_masuk asc';
                        ...
                        <div class="panel-body">
                                  ...
                                  <thead>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="editpolikia.php?ni=<?php echo $data['id_pasien'];?>" class="btn btn-primary btn-sm" ><i class="fa fa-edit">  DETAIL</i></a>
                            ...
                            <a class="btn btn-primary" href="kia.php"><i class="fa fa-success"></i>  Tampilkan semua</a>
                            <!--akhir modal--!>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
