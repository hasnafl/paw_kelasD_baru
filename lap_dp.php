  ...
  <section id="container" class="">
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a class="" href="lap_dp.php">Laporan Data Pasien</a></li>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Laporan</h3>
					<ol class="breadcrumb">
                ...
                <!-- Advanced Tables -->
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <a class="btn btn-primary" data-toggle="modal" data-target="#cetak"><i class="fa fa-print"></i>  Cetak</a>
                            <!--modal--!>
                            <?php
