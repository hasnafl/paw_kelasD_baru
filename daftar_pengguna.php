  ...
  <section id="container" class="">
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a class="" href="daftar_pengguna.php">Daftar Pengguna</a></li>                          
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Admin Menu</h3>
					<ol class="breadcrumb">
                ...
                <!-- Advanced Tables -->
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                  ...
                                  <thead>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <a href="deletepengguna.php?ni=<?php echo $data['nip'];?>" onclick="return confirm('Yakin mau di hapus?');" class="btn btn-success btn-sm"><i class="fa fa-delete">  HAPUS</i></a></td>
                            ...
                            <a class="btn btn-primary" data-toggle="modal" data-target="#tambahuser"><i class="fa fa-plus"></i>  Tambah</a>
                            <!--modal--!>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-tittle">Tambah Pengguna</h4>
                                        </div>
                                        <form method="post" enctype="multipart/form-data" action="savedata.php">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="nama_pengguna" class="control-label">Nama</label>
                                                    <input required type="text" name="nama_pengguna" id="nama_pengguna" class="form-control" placeholder="Masukan Nama">
                                                </div>
                                                <div class="form-group">
                                                    <label for="hak_akses" class="control-label">Hak Akses</label>
                                                    <input required type="text" name="hak_akses" id="hak_akses" class="form-control" placeholder="Hak Akses">
                                                </div>
