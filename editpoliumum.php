          ...
          <div class="col-sm-8 col-sm-offset-0">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input required type="text" name="diagnosa" id="diagnosa" class="form-control" value="<?php echo $diagnosa; ?>">
              </div>
              ...
              <button type="submit" class="btn btn-primary" name="diagnosaumum">SIMPAN</button>
            </form>
          </div>
        </div>
      </div>
