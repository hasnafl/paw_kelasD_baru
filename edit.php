          ...
          <div class="col-sm-8 col-sm-offset-0">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input required type="text" name="umur" class="form-control" value="<?php echo $umur; ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input required type="text" name="jenis_kelamin" class="form-control" value="<?php echo $jenis_kelamin; ?>">
              </div>
              <div class="form-group">
                <label for="poli">Poli</label>
                <input required type="text" name="poli" class="form-control" value="<?php echo $poli; ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input required type="text" name="alamat" class="form-control" rows="3" value="<?php echo $alamat; ?>" >
              </div>
              
              <div class="form-group">
                <label for="keluhan">Keluhan</label>  
                <input required type="text" name="keluhan" class="form-control" rows="3" value="<?php echo $keluhan; ?>" >
              </div>
  
              <button type="submit" class="btn btn-primary" name="tedit">EDIT</button>
            </form>
          </div>
        </div>
      </div>
